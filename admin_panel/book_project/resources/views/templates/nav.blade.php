    ...
    <div class="container">
      <div class="container-inner">	
          ...
          <div class="box box-right">
              ...
              <div style="width: 30px height: 35px !important; color:#fff;"><img src="{{ Auth::user()->img }}" alt="{{ Auth::user()->name }}" style="width:24px; height:24px;  border-radius: 50%;"> {{ Auth::user()->name }}</div>	
          </div>
