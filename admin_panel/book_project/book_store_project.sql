...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2022 at 11:05 PM
...
(7, 'İnkişaf edən bir iş istəyirsiniz? BLOQ BAŞINA diqqət yetirin!', '<p id=\"222b\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The next thing to tackle is of course the&nbsp;<code class=\"gi kw kx ky ks b\">getPostContent</code>&nbsp;method. First we check if the article exists and return false if it does not. With the&nbsp;<code class=\"gi kw kx ky ks b\">$meta_regex</code>&nbsp;we retrieve everything between the&nbsp;<code class=\"gi kw kx ky ks b\">---</code>&nbsp;in the very beginning of your file and the next&nbsp;<code class=\"gi kw kx ky ks b\">---</code>, which will be our meta info. The info is store in the&nbsp;<code class=\"gi kw kx ky ks b\">$meta</code>&nbsp;variable and pass to the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method, which returns the formatted meta info to which we append the date. Afterwards we return an array with the meta info, link, title, which is the result of the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;method and the content, which is the result from the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method. Note that we remove the meta info from the markdown content, before we pass it into the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method.</p>\r\n<p id=\"9c12\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Next we add the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method. First we need to check if the current article has meta information. If so, we split it by row and afterwards split at the colon&nbsp;<code class=\"gi kw kx ky ks b\">:</code>, using the first part as the key and the second as the value in the array we return.</p>\r\n<p id=\"d13c\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Moving on, we already wrote the&nbsp;<code class=\"gi kw kx ky ks b\">getDate</code>&nbsp;method and the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;in the previous post. The latter one needs a little adjusting though. We set the title to the filename, check if the title was set in the meta section and if so we use the title from the meta section.</p>\r\n<p id=\"db40\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">In the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method we initialize a new&nbsp;<code class=\"gi kw kx ky ks b\">CommonMarkConverter</code>&nbsp;and convert our markdown to html which is stored in the&nbsp;<code class=\"gi kw kx ky ks b\">$post</code>&nbsp;variable. Afterwards we render a view and store it into the&nbsp;<code class=\"gi kw kx ky ks b\">$metaInfo</code>&nbsp;variable, with which we will replace the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag in the markdown file. The view gets an array with three variables:&nbsp;<code class=\"gi kw kx ky ks b\">author</code>&nbsp;which we need to check in case no meta info is provided,&nbsp;<code class=\"gi kw kx ky ks b\">date</code>&nbsp;and the&nbsp;<code class=\"gi kw kx ky ks b\">readingTime</code>&nbsp;which will be returned from the&nbsp;<code class=\"gi kw kx ky ks b\">getReadingTime</code>&nbsp;method. We return the post content, replacing the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag with our rendered meta template.</p>\r\n<p class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The blade template is very simple, a div with the author, date and reading time. We only need to add an&nbsp;<code class=\"gi kw kx ky ks b\">@if</code>&nbsp;statement to take care if the case when no author is set. In this case it will be&nbsp;<code class=\"gi kw kx ky ks b\">Published DD/MM/YY * X min read</code>.</p>\r\n<p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec quam tempor, sed efficitur ex ultrices. Phasellus pretium est vel dui vestibulum condimentum. Aenean nec suscipit nibh. Phasellus nec lacus id arcu facilisis elementum. Curabitur lobortis, elit ut elementum congue, erat ex bibendum odio, nec iaculis lacus sem non lorem. Duis suscipit metus ante, sed convallis quam posuere quis. Ut tincidunt eleifend odio, ac fringilla mi vehicula nec. Nunc vitae lacus eget lectus imperdiet tempus sed in dui. Nam molestie magna at risus consectetur, placerat suscipit justo dignissim. Sed vitae fringilla enim, nec ullamcorper arcu.</p>\r\n<p id=\"222b\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The next thing to tackle is of course the&nbsp;<code class=\"gi kw kx ky ks b\">getPostContent</code>&nbsp;method. First we check if the article exists and return false if it does not. With the&nbsp;<code class=\"gi kw kx ky ks b\">$meta_regex</code>&nbsp;we retrieve everything between the&nbsp;<code class=\"gi kw kx ky ks b\">---</code>&nbsp;in the very beginning of your file and the next&nbsp;<code class=\"gi kw kx ky ks b\">---</code>, which will be our meta info. The info is store in the&nbsp;<code class=\"gi kw kx ky ks b\">$meta</code>&nbsp;variable and pass to the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method, which returns the formatted meta info to which we append the date. Afterwards we return an array with the meta info, link, title, which is the result of the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;method and the content, which is the result from the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method. Note that we remove the meta info from the markdown content, before we pass it into the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method.</p>\r\n<p id=\"9c12\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Next we add the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method. First we need to check if the current article has meta information. If so, we split it by row and afterwards split at the colon&nbsp;<code class=\"gi kw kx ky ks b\">:</code>, using the first part as the key and the second as the value in the array we return.</p>\r\n<p id=\"d13c\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Moving on, we already wrote the&nbsp;<code class=\"gi kw kx ky ks b\">getDate</code>&nbsp;method and the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;in the previous post. The latter one needs a little adjusting though. We set the title to the filename, check if the title was set in the meta section and if so we use the title from the meta section.</p>\r\n<p id=\"db40\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">In the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method we initialize a new&nbsp;<code class=\"gi kw kx ky ks b\">CommonMarkConverter</code>&nbsp;and convert our markdown to html which is stored in the&nbsp;<code class=\"gi kw kx ky ks b\">$post</code>&nbsp;variable. Afterwards we render a view and store it into the&nbsp;<code class=\"gi kw kx ky ks b\">$metaInfo</code>&nbsp;variable, with which we will replace the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag in the markdown file. The view gets an array with three variables:&nbsp;<code class=\"gi kw kx ky ks b\">author</code>&nbsp;which we need to check in case no meta info is provided,&nbsp;<code class=\"gi kw kx ky ks b\">date</code>&nbsp;and the&nbsp;<code class=\"gi kw kx ky ks b\">readingTime</code>&nbsp;which will be returned from the&nbsp;<code class=\"gi kw kx ky ks b\">getReadingTime</code>&nbsp;method. We return the post content, replacing the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag with our rendered meta template.</p>\r\n<p class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The blade template is very simple, a div with the author, date and reading time. We only need to add an&nbsp;<code class=\"gi kw kx ky ks b\">@if</code>&nbsp;statement to take care if the case when no author is set. In this case it will be&nbsp;<code class=\"gi kw kx ky ks b\">Published DD/MM/YY * X min read</code>.</p>\r\n<p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec quam tempor, sed efficitur ex ultrices. Phasellus pretium est vel dui vestibulum condimentum. Aenean nec suscipit nibh. Phasellus nec lacus id arcu facilisis elementum. Curabitur lobortis, elit ut elementum congue, erat ex bibendum odio, nec iaculis lacus sem non lorem. Duis suscipit metus ante, sed convallis quam posuere quis. Ut tincidunt eleifend odio, ac fringilla mi vehicula nec. Nunc vitae lacus eget lectus imperdiet tempus sed in dui. Nam molestie magna at risus consectetur, placerat suscipit justo dignissim. Sed vitae fringilla enim, nec ullamcorper arcu.</p>\r\n<p id=\"222b\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The next thing to tackle is of course the&nbsp;<code class=\"gi kw kx ky ks b\">getPostContent</code>&nbsp;method. First we check if the article exists and return false if it does not. With the&nbsp;<code class=\"gi kw kx ky ks b\">$meta_regex</code>&nbsp;we retrieve everything between the&nbsp;<code class=\"gi kw kx ky ks b\">---</code>&nbsp;in the very beginning of your file and the next&nbsp;<code class=\"gi kw kx ky ks b\">---</code>, which will be our meta info. The info is store in the&nbsp;<code class=\"gi kw kx ky ks b\">$meta</code>&nbsp;variable and pass to the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method, which returns the formatted meta info to which we append the date. Afterwards we return an array with the meta info, link, title, which is the result of the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;method and the content, which is the result from the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method. Note that we remove the meta info from the markdown content, before we pass it into the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method.</p>\r\n<p id=\"9c12\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Next we add the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method. First we need to check if the current article has meta information. If so, we split it by row and afterwards split at the colon&nbsp;<code class=\"gi kw kx ky ks b\">:</code>, using the first part as the key and the second as the value in the array we return.</p>\r\n<p id=\"d13c\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">Moving on, we already wrote the&nbsp;<code class=\"gi kw kx ky ks b\">getDate</code>&nbsp;method and the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;in the previous post. The latter one needs a little adjusting though. We set the title to the filename, check if the title was set in the meta section and if so we use the title from the meta section.</p>\r\n<p id=\"db40\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">In the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method we initialize a new&nbsp;<code class=\"gi kw kx ky ks b\">CommonMarkConverter</code>&nbsp;and convert our markdown to html which is stored in the&nbsp;<code class=\"gi kw kx ky ks b\">$post</code>&nbsp;variable. Afterwards we render a view and store it into the&nbsp;<code class=\"gi kw kx ky ks b\">$metaInfo</code>&nbsp;variable, with which we will replace the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag in the markdown file. The view gets an array with three variables:&nbsp;<code class=\"gi kw kx ky ks b\">author</code>&nbsp;which we need to check in case no meta info is provided,&nbsp;<code class=\"gi kw kx ky ks b\">date</code>&nbsp;and the&nbsp;<code class=\"gi kw kx ky ks b\">readingTime</code>&nbsp;which will be returned from the&nbsp;<code class=\"gi kw kx ky ks b\">getReadingTime</code>&nbsp;method. We return the post content, replacing the&nbsp;<code class=\"gi kw kx ky ks b\">{$meta }</code>&nbsp;tag with our rendered meta template.</p>\r\n<p class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The blade template is very simple, a div with the author, date and reading time. We only need to add an&nbsp;<code class=\"gi kw kx ky ks b\">@if</code>&nbsp;statement to take care if the case when no author is set. In this case it will be&nbsp;<code class=\"gi kw kx ky ks b\">Published DD/MM/YY * X min read</code>.</p>\r\n<p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec quam tempor, sed efficitur ex ultrices. Phasellus pretium est vel dui vestibulum condimentum. Aenean nec suscipit nibh. Phasellus nec lacus id arcu facilisis elementum. Curabitur lobortis, elit ut elementum congue, erat ex bibendum odio, nec iaculis lacus sem non lorem. Duis suscipit metus ante, sed convallis quam posuere quis. Ut tincidunt eleifend odio, ac fringilla mi vehicula nec. Nunc vitae lacus eget lectus imperdiet tempus sed in dui. Nam molestie magna at risus consectetur, placerat suscipit justo dignissim. Sed vitae fringilla enim, nec ullamcorper arcu.</p>\r\n<p id=\"222b\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\">The next thing to tackle is of course the&nbsp;<code class=\"gi kw kx ky ks b\">getPostContent</code>&nbsp;method. First we check if the article exists and return false if it does not. With the&nbsp;<code class=\"gi kw kx ky ks b\">$meta_regex</code>&nbsp;we retrieve everything between the&nbsp;<code class=\"gi kw kx ky ks b\">---</code>&nbsp;in the very beginning of your file and the next&nbsp;<code class=\"gi kw kx ky ks b\">---</code>, which will be our meta info. The info is store in the&nbsp;<code class=\"gi kw kx ky ks b\">$meta</code>&nbsp;variable and pass to the&nbsp;<code class=\"gi kw kx ky ks b\">getMeta</code>&nbsp;method, which returns the formatted meta info to which we append the date. Afterwards we return an array with the meta info, link, title, which is the result of the&nbsp;<code class=\"gi kw kx ky ks b\">getTitle</code>&nbsp;method and the content, which is the result from the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method. Note that we remove the meta info from the markdown content, before we pass it into the&nbsp;<code class=\"gi kw kx ky ks b\">getContent</code>&nbsp;method.</p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<p id=\"876a\" class=\"pw-post-body-paragraph ji jj ii jl b jm jn jo jp jq jr js jt kh jv jw jx ki jz ka kb kj kd ke kf kg ib gj\" data-selectable-paragraph=\"\"></p>\r\n<div id=\"gtx-trans\" style=\"position: absolute; left: -37px; top: -10.8993px;\">\r\n<div class=\"gtx-trans-icon\">&nbsp;</div>\r\n</div>', 'uploads/blog/inkisaf-eden-bir-is-isteyirsiniz-bloq-basina-diqqet-yetirin.jpg', 'Quluzadə Ağabala', 'inkisaf-eden-bir-is-isteyirsiniz-bloq-basina-diqqet-yetirin', 2, '0', '2022-04-22 23:41:17', '2022-05-19 18:20:20');
...
(1, 'uploads/users/agabala-quluzade.jpg', 'Ağabala Quluzadə', 'agabala.oyunda@gmail.com', NULL, '$2y$10$cPGszbMKJW.pmeaMh82NLuv99aiiLayGWwS/zKBirMkLEntLuE7pq', 'RINN4Azg0SLQX1ceHNpMl1Wnuu7YJ2fQi1bePyOXIbAcUKGjysYkmBHDRnPT', 'Buzovna', 504946684, 'AZ1090', '2022-05-03 10:47:46', '2022-05-03 20:32:27'),
